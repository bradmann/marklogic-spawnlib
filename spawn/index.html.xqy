...
import module namespace slib = "http://marklogic.com/roxy/models/sec-lib" at "/app/models/sec-lib.xqy";

declare option xdmp:mapping "false";

declare function local:render-page($item as xs:string?) as item()* {
...
slib:elevateHtml(xdmp:function(xs:QName("local:render-page")), "ml-admin-spawnlib-role")